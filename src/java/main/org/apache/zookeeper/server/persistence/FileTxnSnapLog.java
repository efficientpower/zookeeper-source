...
public class FileTxnSnapLog {
    ...
    public void processTransaction(TxnHeader hdr, DataTree dt, Map<Long, Integer> sessions, Record txn) throws KeeperException.NoNodeException {
        ...
        /**
         * Snapshots are lazily created. So when a snapshot is in progress, there is a chance for later transactions to
         * make into the snapshot. Then when the snapshot is restored, NONODE/NODEEXISTS errors could occur. It should
     ...
     * @return the list of n most recent snapshots, with the most recent in front
     * @throws IOException
     */
    ...
    /**
     * get the snapshot logs which may contain transactions newer than the given zxid. This includes logs with starting
     * zxid greater than given zxid, as well as the newest transaction log with starting zxid less than given zxid. The
     * latter log file may contain transactions beyond given zxid.
     * 
     * @param zxid
     ...
     * 
     * @param si
     *            the request to be appended returns true iff something appended, otw false
     * @throws IOException
     */
