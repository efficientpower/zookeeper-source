...
public abstract class ServerCnxnFactory {
     ...
     *
     * If the user has specified a "ZooKeeperServer.LOGIN_CONTEXT_NAME_KEY" or a jaas.conf using
     * "java.security.auth.login.config" the authentication is required and an exception is raised. Otherwise no
     * authentication is configured and no exception is raised.
     *
     * @throws IOException
