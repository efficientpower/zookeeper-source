...
/**
 * This class manages the cleanup of snapshots and corresponding transaction logs by scheduling the auto purge task with
 * the specified 'autopurge.purgeInterval'. It keeps the most recent 'autopurge.snapRetainCount' number of snapshots and
...
public class DatadirCleanupManager {
    ...
    /**
     * Validates the purge configuration and schedules the purge task. Purge task keeps the most recent
     * <code>snapRetainCount</code> number of snapshots and deletes the remaining for every <code>purgeInterval</code>
     * hour(s).
     * <p>
     * <code>purgeInterval</code> of <code>0</code> or <code>negative integer</code> will not schedule the purge task.
     * </p>
     * 
