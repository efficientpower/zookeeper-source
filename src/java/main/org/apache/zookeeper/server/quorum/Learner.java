...
/**
 * This class is the superclass of two of the three main actors in a ZK ensemble: Followers and Observers. Both
 * Followers and Observers share a good deal of code which is moved into Peer to avoid duplication.
 */
public class Learner {
     ...
     * @throws IOException
     *             <li>if the socket connection fails on the 5th attempt</li>
    ...
    protected void syncWithLeader(long newLeaderZxid) throws IOException, InterruptedException {
        ...
        synchronized (zk) {
            ...
            outerLoop: while (self.isRunning()) {
                ...
                switch (qp.getType()) {
                    ...
                    case Leader.INFORM:
                        /*
                         * Only observer get this type of packet. We treat this as receiving PROPOSAL and COMMMIT.
                         */
                    ...
                    case Leader.NEWLEADER: // Getting NEWLEADER here instead of in discovery
                        ...
                        writeToTxnLog = true; // Anything after this needs to go to the transaction log, not applied
                                              // directly in memory
                        isPreZAB1_0 = false;
        ...
        zk.startup();
        /*
         * Update the election vote here to ensure that all members of the ensemble report the same vote to new servers
         * that start up and send leader election notifications to the ensemble.
         * 
