...
public class Vote {
    ...
    public boolean equals(Object o) {
        ...
        /*
         * There are two things going on in the logic below. First, we compare votes of servers out of election using
         * only id and peer epoch. Second, if one version is 0x0 and the other isn't, then we only use the leader id.
